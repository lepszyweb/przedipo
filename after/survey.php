...
if(isset($submit)) {
  ...
  <body>
    <div id="meta-header">
      <p id="skipnav"><a href="#page">Przejdź na początek demo dostępnej strony</a></p>
      ...
      <h1><span class="subhead">Dostępna strona Start</span><span class="hidden"> -</span> Demo Przed i Po modernizacji</h1>
      ...
      <div id="mnav" class="accessible">
        <ul>
          ...
          <li class="current"><span class="hidden">Jesteś tutaj:: </span>Ankieta
            ...
            </ul><a href="./annotated/survey.html" class="annotoggle">Pokaż <br>adnotacje</a></div>
          </li>
