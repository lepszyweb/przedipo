...
if(isset($submit)) {
if (!$error) {
echo "Sondaż Świateł Miasta - Wysyłka zakończona [Niedostępna strona Ankieta z komentarzem]";
} else {
echo "Sondaż Świateł Miasta - Wysyłka nieudana [Niedostępna strona Ankieta z komentarzem]";
}
} else {
echo "Sondaż Świateł Miasta [Niedostępna strona Ankieta z komentarzem]";
}
?></title>
  ...
  <body text="#000000" bgcolor="d7d7cd" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" link="#226c8e" vlink="#226c8e" alink="226c8ee">
    <div id="meta-header">
      ...
      <h1>Demo Przed i Po: Niedostępna strona Ankieta z komentarzem</h1>
        ...
        <ul>
          ...
          <li class="current"><span class="hidden">Jesteś tutaj: </span>Ankieta
            <div class="subnav">
              ...
              <a href="../survey.html" class="annotoggle">Pokaż <br>komentarze</a>
            </div>
          </li>
...
if(!$name) {?>
                        ...
                        <div style="clear:both;width:100%;padding:0px;margin:0px;">
                          <div id="data" class="annot_link_parent"style="float:left">
                            <p style="padding-bottom:0px; margin-bottom:0px; width:300px; height:40px; overflow: hidden;" class=headline>
                              <font size="3">Wyniki ankiety z ostatniego tygodnia</font>
                            </p>
                            <p><b>Jakie są twoje ulubione i najmniej ulubione organy?</b></p>
   ...
   <table width="850" border="1" style="float:left; border: 1px dashed silver;">
                            ...
                            <span id="annot_link_07" class="annot_link prev_sib" style="margin-left: -19.2em !important;padding-right: 19.2em;margin-top:4.5em;">
                              <a href="#annot_07" title="07: Sekwencja czytania jest nielogiczna">07</a>
                            </span>
                            <p>&nbsp;</p>
                          </div>
                  ...
                  <table width="1168" height="36" border="0" cellspacing="0" cellpadding="0" bgcolor="#ededed">	
                    ...
                    <tr height="36">
                      ...
                      <td align="right" class="footer" >
                        <a rel="Copyright" href="https://lepszyweb.pl">LepszyWeb.pl. Pracownia Dostępności Cyfrowej</a> &copy; 2019 &nbsp;&nbsp;&nbsp;<a rel="Copyright" href="http://www.w3.org/Consortium/Legal/ipr-notice#Copyright">Copyright</a> &copy; 2012 <a href="http://www.w3.org/"><acronym title="World Wide Web Consortium">W3C</acronym></a><sup>&reg;</sup> (<a href="http://www.csail.mit.edu/"><acronym title="Massachusetts Institute of Technology">MIT</acronym></a>, <a href="http://www.ercim.org/"><acronym title="European Research Consortium for Informatics and Mathematics">ERCIM</acronym></a>, <a href="http://www.keio.ac.jp/">Keio</a>)
                      </td>
                      <td width="10"> </td>
                    </tr>
                  </table>
...
if ($error) {?>
  ...
  <div id="meta-footer" class="meta">
    ...
    <div class="meta-footer-in">
      <p><strong>Przed i Po</strong> wydanie polskie. Copyright <a href="https://lepszyweb.pl">LepszyWeb.pl. Pracownia Dostępności Cyfrowej</a> &copy; 2019.</p>
      <div class="copyright">
