var reportTable = function ()
{
  ...
  var _defaultOptions = {
    ...
    ,  textCollapseText: ['Pokaż pełny opis', 'Ukryj pełny opis']
    ,  openButtonSrc: {  principle : '../../img/minus_icon.svg'
    ,  guideline: '../../img/minus_guideline_icon.svg'
    ,  criterion: '../../img/minus_criterion_icon.svg' }
    ,  openButtonAlt: 'Otwarte'
    ,  closeButtonSrc: {  principle : '../../img/plus_icon.svg'
    ,  guideline: '../../img/plus_guideline_icon.svg'
    ,  criterion: '../../img/plus_criterion_icon.svg' }
    ,  closeButtonAlt: 'Zamknięte'
  ...
  this.setTable = function (t) {
    ...
    if (t.nodeType != 1 || t.nodeName.toLowerCase() != 'table') {
      throw "Element tabeli nie został znaleziony.";
    }
  ...
  ,  addFoldAllButtons : function (options) {
      ...
      do {
        ...
        expandElm.appendChild(
            document.createTextNode( 'Rozwiń wszystkie wiersze' )
          );
        collapseElm.appendChild(
            document.createTextNode( 'Zwiń wszystkie wiersze' )
          );
